...
if __name__ == '__main__':
    app.run_server()
# Which site has the largest successful launches? -> VAFB SLC-4E
# Which site has the highest launch success rate? -> KSC LC-39A
# Which payload range(s) has the highest launch success rate? -> 2k-4k
# Which payload range(s) has the lowest launch success rate? -> 6k-7k
